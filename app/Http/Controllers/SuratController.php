...
// }
      ...
      if($req->input('user_id') ){
        ...
        // else if($req->input('surat_jenis_id')){
            ...
            if ($req->keyword == ""  && $req->surat_jenis_id == "" ) {
              ...
              $data = DB::table('surat')->join('surat_jenis', 'surat_jenis.id', '=', "surat.surat_jenis_id")->select('surat.*', 'surat_jenis.nama as surat_jenis_nama')->where('status', $req->input('status'))
  ...
  public function listPerizinanMasuk(Request $req) {
    try{
      if ($req->keyword == ""  && $req->surat_jenis_id == "" ) {
    ...
    $surat = DB::table('surat')->join('surat_jenis', 'surat_jenis.id', '=', "surat.surat_jenis_id")->select('surat.*','surat.id as id_surat', 'surat_jenis.nama as surat_jenis_nama')->where('surat.is_terlambat','N')->whereNotIn('surat.status', ['Selesai', 'Ditolak'])->get();
        ...
        $surat = DB::table('surat')->join('surat_jenis', 'surat_jenis.id', '=', "surat.surat_jenis_id")->select('surat.*','surat.id as id_surat', 'surat_jenis.nama as surat_jenis_nama')->where('surat.is_terlambat','N')->whereNotIn('surat.status', ['Selesai', 'Ditolak'])->where('surat.id', 'like', "%" .$req->input('keyword') . "%" )->get();
      }else if ($req->keyword == ""  && $req->surat_jenis_id != "" ) {
        $surat = DB::table('surat')->join('surat_jenis', 'surat_jenis.id', '=', "surat.surat_jenis_id")->select('surat.*','surat.id as id_surat', 'surat_jenis.nama as surat_jenis_nama')->where('surat.is_terlambat','N')->whereNotIn('surat.status', ['Selesai', 'Ditolak'])->where('surat_jenis_id', $req->input('surat_jenis_id'))->get();
      }else if ($req->keyword != ""  && $req->surat_jenis_id != "" ) {
        $surat = DB::table('surat')->join('surat_jenis', 'surat_jenis.id', '=', "surat.surat_jenis_id")->select('surat.*','surat.id as id_surat', 'surat_jenis.nama as surat_jenis_nama')->where('surat.is_terlambat','N')->whereNotIn('surat.status', ['Selesai', 'Ditolak'])->where('surat.id', 'like', "%" .$req->input('keyword') . "%" )
        ->where('surat_jenis_id', $req->input('surat_jenis_id'))->get();
      }
  ...
  public function listPerizinanTerlambat(Request $req) {
    try{
      if ($req->keyword == ""  && $req->surat_jenis_id == "" ) {
    ...
    $surat = DB::table('surat')->join('surat_jenis', 'surat_jenis.id', '=', "surat.surat_jenis_id")->select('surat.*','surat.id as id_surat', 'surat_jenis.nama as surat_jenis_nama')->where('surat.is_terlambat','Y')->whereNotIn('surat.status', ['Selesai', 'Ditolak'])->get();
        ...
        $surat = DB::table('surat')->join('surat_jenis', 'surat_jenis.id', '=', "surat.surat_jenis_id")->select('surat.*','surat.id as id_surat', 'surat_jenis.nama as surat_jenis_nama')->where('surat.is_terlambat','Y')->whereNotIn('surat.status', ['Selesai', 'Ditolak'])->where('surat.id', 'like', "%" .$req->input('keyword') . "%" )->get();
      }else if ($req->keyword == ""  && $req->surat_jenis_id != "" ) {
        $surat = DB::table('surat')->join('surat_jenis', 'surat_jenis.id', '=', "surat.surat_jenis_id")->select('surat.*','surat.id as id_surat', 'surat_jenis.nama as surat_jenis_nama')->where('surat.is_terlambat','Y')->whereNotIn('surat.status', ['Selesai', 'Ditolak'])->where('surat_jenis_id', $req->input('surat_jenis_id'))->get();
      }else if ($req->keyword != ""  && $req->surat_jenis_id != "" ) {
        $surat = DB::table('surat')->join('surat_jenis', 'surat_jenis.id', '=', "surat.surat_jenis_id")->select('surat.*','surat.id as id_surat', 'surat_jenis.nama as surat_jenis_nama')->where('surat.is_terlambat','Y')->whereNotIn('surat.status', ['Selesai', 'Ditolak'])->where('surat.id', 'like', "%" .$req->input('keyword') . "%" )
        ->where('surat_jenis_id', $req->input('surat_jenis_id'))->get();
      }
  ...
  public function listPerizinanDikembalikan(Request $req) {
    try{
      if ($req->keyword == ""  && $req->surat_jenis_id == "" ) {

    $surat = DB::table('surat')->join('surat_jenis', 'surat_jenis.id', '=', "surat.surat_jenis_id")->select('surat.*','surat.id as id_surat', 'surat_jenis.nama as surat_jenis_nama')->where('surat.is_dikembalikan','Y')->whereNotIn('surat.status', ['Selesai', 'Ditolak'])->get();
      } else if ($req->keyword != ""  && $req->surat_jenis_id == "" ) {
        $surat = DB::table('surat')->join('surat_jenis', 'surat_jenis.id', '=', "surat.surat_jenis_id")->select('surat.*','surat.id as id_surat', 'surat_jenis.nama as surat_jenis_nama')->where('surat.is_dikembalikan','Y')->whereNotIn('surat.status', ['Selesai', 'Ditolak'])->where('surat.id', 'like', "%" .$req->input('keyword') . "%" )->get();
      }else if ($req->keyword == ""  && $req->surat_jenis_id != "" ) {
        $surat = DB::table('surat')->join('surat_jenis', 'surat_jenis.id', '=', "surat.surat_jenis_id")->select('surat.*','surat.id as id_surat', 'surat_jenis.nama as surat_jenis_nama')->where('surat.is_dikembalikan','Y')->whereNotIn('surat.status', ['Selesai', 'Ditolak'])->where('surat_jenis_id', $req->input('surat_jenis_id'))->get();
      }else if ($req->keyword != ""  && $req->surat_jenis_id != "" ) {
        $surat = DB::table('surat')->join('surat_jenis', 'surat_jenis.id', '=', "surat.surat_jenis_id")->select('surat.*','surat.id as id_surat', 'surat_jenis.nama as surat_jenis_nama')->where('surat.is_dikembalikan','Y')->whereNotIn('surat.status', ['Selesai', 'Ditolak'])->where('surat.id', 'like', "%" .$req->input('keyword') . "%" )
        ->where('surat_jenis_id', $req->input('surat_jenis_id'))->get();
      }
  ...
  public function listPerizinanDiterbitkan(Request $req) {
    try{
      if ($req->keyword == ""  && $req->surat_jenis_id == "" ) {

    $surat = DB::table('surat')->join('surat_jenis', 'surat_jenis.id', '=', "surat.surat_jenis_id")->select('surat.*','surat.id as id_surat', 'surat_jenis.nama as surat_jenis_nama')->where('surat.status','Selesai')->get();
      } else if ($req->keyword != ""  && $req->surat_jenis_id == "" ) {
        $surat = DB::table('surat')->join('surat_jenis', 'surat_jenis.id', '=', "surat.surat_jenis_id")->select('surat.*','surat.id as id_surat', 'surat_jenis.nama as surat_jenis_nama')->where('surat.status','Selesai')->where('surat.id', 'like', "%" .$req->input('keyword') . "%" )->get();
      }else if ($req->keyword == ""  && $req->surat_jenis_id != "" ) {
        $surat = DB::table('surat')->join('surat_jenis', 'surat_jenis.id', '=', "surat.surat_jenis_id")->select('surat.*','surat.id as id_surat', 'surat_jenis.nama as surat_jenis_nama')->where('surat.status','Selesai')->where('surat_jenis_id', $req->input('surat_jenis_id'))->get();
      }else if ($req->keyword != ""  && $req->surat_jenis_id != "" ) {
        $surat = DB::table('surat')->join('surat_jenis', 'surat_jenis.id', '=', "surat.surat_jenis_id")->select('surat.*','surat.id as id_surat', 'surat_jenis.nama as surat_jenis_nama')->where('surat.status','Selesai')->where('surat.id', 'like', "%" .$req->input('keyword') . "%" )
        ->where('surat_jenis_id', $req->input('surat_jenis_id'))->get();
      }
      ...
      ->addColumn('nama_surveyor', function ($data) {
        ...
        ->addColumn('aksi', function ($data) {
          ...
          return  '<div class="btn-group">'.
                ...
                '</div>';
              }else if(Auth::user()->role_id == 6 || Auth::user()->role_id == 1){
